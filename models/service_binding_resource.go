...
func (m *ServiceBindingResource) validateEndpoints(formats strfmt.Registry) error {
...
func (m *ServiceBindingResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *ServiceBindingResource) contextValidateEndpoints(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServiceBindingResource) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
