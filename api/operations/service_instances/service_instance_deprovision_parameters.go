...
// ServiceInstanceDeprovisionParams contains all the bound params for the service instance deprovision operation
...
func (o *ServiceInstanceDeprovisionParams) bindXBrokerAPIOriginatingIdentity(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ServiceInstanceDeprovisionParams) bindXBrokerAPIRequestIdentity(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ServiceInstanceDeprovisionParams) bindXBrokerAPIVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *ServiceInstanceDeprovisionParams) bindAcceptsIncomplete(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ServiceInstanceDeprovisionParams) bindInstanceID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ServiceInstanceDeprovisionParams) bindPlanID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *ServiceInstanceDeprovisionParams) bindServiceID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
