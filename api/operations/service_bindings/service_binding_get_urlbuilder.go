...
func (o *ServiceBindingGetURL) Build() (*url.URL, error) {
	...
	if bindingID != "" {
		...
		return nil, errors.New("bindingId is required on ServiceBindingGetURL")
	}
	...
	if instanceID != "" {
		...
		return nil, errors.New("instanceId is required on ServiceBindingGetURL")
	}
...
func (o *ServiceBindingGetURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ServiceBindingGetURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ServiceBindingGetURL")
	}
