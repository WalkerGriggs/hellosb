...
func (o *ServiceInstanceLastOperationGetURL) Build() (*url.URL, error) {
	...
	var _path = "/v2/service_instances/{instance_id}/last_operation"

	instanceID := o.InstanceID
	if instanceID != "" {
		_path = strings.Replace(_path, "{instance_id}", instanceID, -1)
	} else {
		return nil, errors.New("instanceId is required on ServiceInstanceLastOperationGetURL")
	}
	...
	if planIDQ != "" {
		qs.Set("plan_id", planIDQ)
	}

	var serviceIDQ string
	if o.ServiceID != nil {
		serviceIDQ = *o.ServiceID
	}
	if serviceIDQ != "" {
...
func (o *ServiceInstanceLastOperationGetURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ServiceInstanceLastOperationGetURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ServiceInstanceLastOperationGetURL")
	}
