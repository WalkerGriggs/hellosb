...
func (o *ServiceInstanceUpdateURL) Build() (*url.URL, error) {
	...
	if instanceID != "" {
		...
		return nil, errors.New("instanceId is required on ServiceInstanceUpdateURL")
	}
...
func (o *ServiceInstanceUpdateURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ServiceInstanceUpdateURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ServiceInstanceUpdateURL")
	}
