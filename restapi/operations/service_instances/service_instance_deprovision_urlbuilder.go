...
func (o *ServiceInstanceDeprovisionURL) Build() (*url.URL, error) {
	...
	if instanceID != "" {
		...
		return nil, errors.New("instanceId is required on ServiceInstanceDeprovisionURL")
	}
...
func (o *ServiceInstanceDeprovisionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ServiceInstanceDeprovisionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ServiceInstanceDeprovisionURL")
	}
